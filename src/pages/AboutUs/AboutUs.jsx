...
const AboutUs = () => {
  ...
  const aboutStructuredData = {
    ...
    "mainEntity": {
      ...
      "description": "AIBSH TECHNOLOGIES PVT LTD was born from a simple yet powerful vision: to bridge the gap between innovative ideas and technological reality. We believe that every business challenge is an opportunity for digital transformation.",
      "foundingDate": "2020",
    ...
    <>
      ...
      <section className="relative w-full aspect-video min-h-[60vh] max-h-[80vh]">
        ...
        <img
          ...
          alt="AIBSH TECHNOLOGIES PVT LTD About Us Banner - Our Digital Innovation Journey"
        />
      ...
      <section className="py-14 bg-white text-black relative z-0">
        ...
        <div className="wrapper">
          <h2 data-aos="fade-up" className="text1 text-center">
            The AIBSH TECHNOLOGIES PVT LTD Journey
          </h2>
      ...
      <section className="py-14 relative">
        ...
        <div className="wrapper flex flex-col-reverse md:grid grid-cols-2 gap-7">
          <div data-aos="fade-up" className="space-y-3">
            ...
            <p className="desc">
              At AIBSH TECHNOLOGIES PVT LTD, we're not just a service provider—we're your strategic partner in digital transformation. Our commitment extends far beyond project completion, ensuring your long-term success in an ever-evolving digital landscape.
            </p>
      ...
      <section className="z-[-2] bg-white text-black py-14 relative overflow-hidden">
        ...
        <div className="wrapper grid md:grid-cols-[40%_1fr] items-center gap-7">
          ...
          <div data-aos="fade-up" className="space-y-3">
            ...
            <p className="desc">
              At AIBSH TECHNOLOGIES PVT LTD, we’re committed to your growth, even after
