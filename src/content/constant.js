...
export const industries = [
  {
    ...
    desc: "AIBSH TECHNOLOGIES PVT LTD revolutionizes financial services with secure, scalable fintech solutions, AI-powered risk assessment, and blockchain integration for modern banking operations.",
  },
  {
    id: 2,
    title: "Healthcare and Biotech",
    image: "/assets/images/icons/Healthcare and Biotech.png",
    desc: "AIBSH TECHNOLOGIES PVT LTD transforms healthcare delivery with AI-powered diagnostics, telemedicine platforms, and data-driven solutions that enhance patient care and operational efficiency.",
  },
  {
    id: 3,
    title: "E-commerce and Retail",
    image: "/assets/images/icons/E-commerce and Retail.png",
    desc: "AIBSH TECHNOLOGIES PVT LTD creates immersive e-commerce experiences with AI-driven personalization, AR-powered shopping, and scalable platforms that drive conversion and customer engagement.",
  },
  {
    id: 4,
    title: "Gaming and Entertainment",
    image: "/assets/images/icons/Gaming and Entertainment.png",
    desc: "AIBSH TECHNOLOGIES PVT LTD crafts next-generation gaming experiences with cutting-edge graphics, multiplayer systems, and immersive AR/VR technologies that captivate audiences worldwide.",
  },
  {
    id: 5,
    title: "Logistics and Supply Chain",
    image: "/assets/images/icons/Logistics and Supply Chain Management.png",
    desc: "AIBSH TECHNOLOGIES PVT LTD optimizes supply chains with IoT-driven tracking, AI-powered route optimization, and real-time analytics that enhance efficiency and reduce operational costs.",
  },
  {
    id: 6,
    title: "Education and E-Learning",
    image: "/assets/images/icons/Education and E-Learning.png",
    desc: "AIBSH TECHNOLOGIES PVT LTD revolutionizes education with adaptive learning platforms, virtual classrooms, and AI-powered content personalization that enhances student engagement and outcomes.",
  },
  {
    id: 7,
    title: "Restaurants and Hotels",
    image: "/assets/images/icons/Restaurants and Hotels.png",
    desc: "AIBSH TECHNOLOGIES PVT LTD elevates hospitality with smart booking systems, AI-powered guest services, and digital solutions that enhance customer experiences and operational efficiency.",
  },
];
...
export const testimonials = [
  {
    ...
    review:
      "AIBSH TECHNOLOGIES PVT LTD transformed our healthcare platform with AI-powered diagnostics and seamless patient management. Their innovative approach and technical expertise exceeded all our expectations.",
    position: "CTO",
  ...
  },
  {
    ...
    review:
      "Working with AIBSH TECHNOLOGIES PVT LTD was a game-changer for our fintech startup. They delivered a secure, scalable platform that helped us process millions of transactions with zero downtime.",
  ...
  },
  {
    ...
    review:
      "AIBSH TECHNOLOGIES PVT LTD's AI and data science solutions revolutionized our e-commerce platform. Their personalized recommendation engine increased our conversion rates by 40% within the first quarter.",
...
export const futureGoals = [
  {
    ...
    description:
      "AIBSH TECHNOLOGIES PVT LTD is committed to expanding our service portfolio to meet the evolving needs of modern businesses, becoming the go-to partner for transformative technology solutions.",
  },
  {
  ...
  },
  {
    ...
    description:
      "AIBSH TECHNOLOGIES PVT LTD focuses on building long-term partnerships with our clients, understanding their evolving needs and providing ongoing support to ensure their continued success.",
  },
  {
  ...
  },
  {
    ...
    description:
      "AIBSH TECHNOLOGIES PVT LTD aims to expand our global presence, serving clients across different continents while maintaining our commitment to personalized service and local market understanding.",
  },
  {
    ...
    <div>
      <p class="mb-8">
       <span class="text4 text-primary1">1. Customized Websites for Your Unique Needs : </span>
        From patient engagement to operational efficiency, AIBSH TECHNOLOGIES PVT LTD develops healthcare websites that transform how you deliver care. Types of websites we offer include:
      </p>
...
`,
  ...
  <p class="mb-8">
    ...
    <br />
    Why Invest in Healthcare Apps? Mobile apps provide a transformative platform for engaging patients, streamlining operations, and enhancing care delivery. By aligning with your specifications, AIBSH TECHNOLOGIES PVT LTD ensures tailored apps that meet the dynamic needs of modern healthcare.
  </p>
...
`,
  ...
  <p class="mb-8">
    ...
    <br />
    Data holds the power to transform healthcare, but unlocking its potential requires advanced tools and expertise. AIBSH TECHNOLOGIES PVT LTD offers data science services designed to improve patient outcomes, streamline operations, and enable informed decision-making.
  </p>
...
`,
  ...
  <p class="mb-8">
    ...
    <br />
    Tailored Technology to Meet Complex Needs Generic software often fails to address healthcare-specific challenges. AIBSH TECHNOLOGIES PVT LTD’s custom software solutions bridge the gap by delivering:
  </p>
...
// Export logo and other images at the end
export { logo };
export { circleImg };
export { moonShapeImg };
